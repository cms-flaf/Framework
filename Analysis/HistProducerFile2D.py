...
def GetHistogramDictFromDataframes(var, all_dataframes, key_2 , key_filter_dict, unc_cfg_dict,hist_cfg_dict, wantBTag=True, furtherCut=''):
...
def GetHistograms(var, inFile,dataset,outfile,unc_cfg_dict, sample_cfg_dict, deepTauVersion, compute_unc_variations, compute_rel_weights, furtherCut='', wantBTag=False):
    ...
    central_histograms = GetHistogramDictFromDataframes(var, all_dataframes, key_central , key_filter_dict, unc_cfg_dict['norm'],hist_cfg_dict, wantBTag,furtherCut)
    ...
    if compute_rel_weights and dataset!='data':
        for uncName in unc_cfg_dict['norm'].keys():
            for scale in scales:
                ...
                norm_histograms =  GetHistogramDictFromDataframes(var,all_dataframes, key_2, key_filter_dict,unc_cfg_dict['norm'], hist_cfg_dict, wantBTag,furtherCut)
    ...
    if compute_unc_variations and dataset!='data':
        for uncName in unc_cfg_dict['shape']:
            for scale in scales:
                ...
                shape_histograms=  GetHistogramDictFromDataframes(var, all_dataframes, key_2 , key_filter_dict,unc_cfg_dict['shape'], hist_cfg_dict, wantBTag, furtherCut)
