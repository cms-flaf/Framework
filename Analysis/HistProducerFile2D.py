...
def GetHistograms(inFile,dataset,outfiles,unc_cfg_dict, sample_cfg_dict, models,deepTauVersion, compute_unc_variations, compute_rel_weights, furtherCut='', wantBTag=False):
    ...
    central_histograms = GetHistogramDictFromDataframes(all_dataframes, key_central , models, key_filter_dict, unc_cfg_dict['norm'], wantBTag,furtherCut)
    ...
    if compute_rel_weights and dataset!='data':
        for uncName in unc_cfg_dict['norm'].keys():
            for scale in scales:
                ...
                norm_histograms =  GetHistogramDictFromDataframes(all_dataframes, key_2, models, key_filter_dict,unc_cfg_dict['norm'], wantBTag,furtherCut)
    ...
    if compute_unc_variations and dataset!='data':
        for uncName in unc_cfg_dict['shape']:
            for scale in scales:
                ...
                shape_histograms=  GetHistogramDictFromDataframes(all_dataframes, key_2 , models, key_filter_dict,unc_cfg_dict['shape'], wantBTag, furtherCut)
