            ...
            for idx in range(nInputs):
                with contextlib.ExitStack() as stack:
                    ...
                    if len(self.input()) > 1:
                        ...
                        local_cache_files = [stack.enter_context(inp.localize('r')).path for inp in np_inputs[1:,idx]]
                    ...
                    with input_file.localize("r") as local_input:
                        ...
                        if len(self.input()) > 1:
                            analysisCacheProducer_cmd.extend([ '--cacheFileNames', ','.join(local_cache_files)])
