...
class Setup:
    ...
    def __init__(self, ana_path, period, customisations=None):
        ...
        for producer_name, producer_config in self.global_params["payload_producers"].items():
            columns_delivered = producer_config["columns"] if "columns" in producer_config else None
