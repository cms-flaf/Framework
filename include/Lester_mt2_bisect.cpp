...
EllipseParams::EllipseParams(const double c_xx2, const double c_yy2,
                             const double c_xy2, const double c_x2,
...
double
asymm_mt2_lester_bisect::get_mT2( // returns asymmetric mT2 (which is >=0), or
    ...
    const double
        desiredPrecisionOnMT2, // This must be non-negative.  If set to zero
                               ...
                               // factor of ...
    const bool
        useDeciSectionsInitially // If true, interval is cut at the 10% point
...
double
asymm_mt2_lester_bisect::get_mT2_Sq( // returns square of asymmetric mT2 (which
  ...
  disableCopyrightMessage(
      false); // By supplying an argument to disable, we actually ask for the
...
const Lester::EllipseParams asymm_mt2_lester_bisect::helper(
...
double asymm_mt2_lester_bisect::MT(double px1, double px2, double py1,
                                   double py2, double m1, double m2) {
...
std::pair<double, double> asymm_mt2_lester_bisect::ben_findsols(
    double MT2, double px, double py, double visM, double Ma, double pxb,
    double pyb, double metx, double mety, double visMb, double Mb) {
