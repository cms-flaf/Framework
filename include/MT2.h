...
template <typename LVector1, typename LVector2, typename LVector3,
          typename LVector4, typename LVector5>
double Calculate_MT2(const LVector1 &lepton1_p4, const LVector2 &lepton2_p4,
                     const LVector3 &bjet_1, const LVector4 &bjet_2,
  ...
  double chiA =
      lepton1_p4
          .mass(); // hypothesised mass of invisible on side A.  Must be >=0.
  double chiB =
      lepton2_p4
          .mass(); // hypothesised mass of invisible on side B.  Must be >=0.
  double MT2 = asymm_mt2_lester_bisect::get_mT2(
      mVisA, pxA, pyA, mVisB, pxB, pyB, pxMiss, pyMiss, chiA, chiB, 0);
  return MT2;
}
...
template <typename LVector1, typename LVector2, typename LVector3>
double Calculate_MT2_func(const LVector1 &visible1, const LVector2 &visible2,
                          const LVector3 &invisible, const double massHypo1,
  ...
  double chiA =
      massHypo1; // hypothesised mass of invisible on side A.  Must be >=0.
  double chiB =
      massHypo2; // hypothesised mass of invisible on side B.  Must be >=0.
  double MT2 = asymm_mt2_lester_bisect::get_mT2(
      mVisA, pxA, pyA, mVisB, pxB, pyB, pxMiss, pyMiss, chiA, chiB, 0);
  return MT2;
}
