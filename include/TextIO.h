...
namespace analysis {
    ...
    std::vector<std::string> ToStringVector(const std::vector<T> &v) {
        ...
        std::transform(v.begin(), v.end(), std::back_inserter(result), [](const T &x) {
            std::ostringstream ss;
            ss << x;
            return ss.str();
        });
    ...
    Collection SplitValueListT(const std::string &values_str,
        ...
        std::transform(
            list.begin(), list.end(), std::inserter(collection, collection.end()), [](const std::string &str) {
                return Parse<T>(str);
            });
        return collection;
    }
    ...
    namespace detail {
        inline std::string LorentzVectorToString(double px,
                                                 double py,
                                                 double pz,
                                                 double E,
                                                 double mass,
    ...
    std::string LorentzVectorToString(const LVector &p4,
        ...
        return detail::LorentzVectorToString(
            p4.Px(), p4.Py(), p4.Pz(), p4.E(), p4.M(), p4.Pt(), p4.Eta(), p4.Phi(), repr, print_prefix);
    }
