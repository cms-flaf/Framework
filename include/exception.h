    ...
    class exception : public std::exception {
      public:
        ...
        exception(const exception &e) noexcept
            : msg(std::make_unique<std::string>(*e.msg)),
              msg_valid(std::make_unique<bool>(*e.msg_valid)),
              f_str(e.f_str),
        ...
        exception(exception &&e) noexcept
            : msg(std::move(e.msg)),
              msg_valid(std::move(e.msg_valid)),
              f_msg(std::move(e.f_msg)),
              f_str(e.f_str),
              stack_trace(e.stack_trace) {}
      ...
      private:
        void process_unexpected_exception(const std::exception &e) const {
            *msg =
                "An exception has been raised while creating an error message. "
                "Error message = '" +
