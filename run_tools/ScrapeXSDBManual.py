...
if __name__ == '__main__':
        ...
        import argparse
        parser = argparse.ArgumentParser(description='Manually scrape the temporary XSDB website locally when the API website is down')
        ...
        parser.add_argument('--XSDB-website', required=False, default='https://xsdb-temp.app.cern.ch/xsdb', type=str, help="XSDB website to scrape")
